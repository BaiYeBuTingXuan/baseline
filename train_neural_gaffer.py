...
from Neural_Gaffer.parse_args import parse_args
import diffusers
...
from pipeline.NeuralGaffer import _batch_preprocess
...
DATA_PATH = "/media/HDD1/hejun/LavalObjaverseDataset"
from Neural_Gaffer.pipeline_neural_gaffer import Neural_Gaffer_StableDiffusionPipeline
from dataset.LavalObjaverseDataset import SingleView_Train_Dataset
...
def main(args):
    ...
    train_dataset = SingleView_Train_Dataset(
            DATA_PATH, 
    ...
    validation_dataset = SingleView_Train_Dataset(
            DATA_PATH, 
            object_split='training', 
            lighting_split='training', 
            view_split='training', 
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if validation_loader is not None and (global_step % args.validation_steps == 0 or global_step == (100 +initial_global_step)):
                        if args.use_ema:
